...
| [`rpc-provider-analysis.md`](rpc-provider-analysis.md) | 2026-05 | RPC budget / provider comparison | Operational reference — check against current `config/chains.yaml` |
