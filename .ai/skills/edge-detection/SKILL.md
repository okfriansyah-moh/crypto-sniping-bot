...
- Architecture context: `docs/architecture-context/5_sniper_mode.md`
- DTO spec: `docs/dto_contracts.md` § 3.4 (EdgeDTO)
- Roadmap: `docs/implementation_roadmap.md` Phase 2.3
