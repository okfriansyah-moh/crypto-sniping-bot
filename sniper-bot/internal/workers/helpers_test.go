...
func (s *stubAdapter) ListRecentEvents(_ context.Context, _ string, _ int) ([]database.RecentEventRow, error) {
	return nil, nil
}
func (s *stubAdapter) GetDQBreakdown(_ context.Context, _ int, _ string) (*database.DQBreakdown, error) {
	return nil, nil
}
