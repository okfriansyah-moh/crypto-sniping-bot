...
func (a *dispatcherStubAdapter) ListRecentEvents(_ context.Context, _ string, _ int) ([]database.RecentEventRow, error) {
	return nil, nil
}
func (a *dispatcherStubAdapter) GetDQBreakdown(_ context.Context, _ int, _ string) (*database.DQBreakdown, error) {
