...
func (m *memAdapter) ListRecentEvents(_ context.Context, _ string, _ int) ([]database.RecentEventRow, error) {
	return nil, nil
}
func (m *memAdapter) GetDQBreakdown(_ context.Context, _ int, _ string) (*database.DQBreakdown, error) {
	return nil, nil
}
