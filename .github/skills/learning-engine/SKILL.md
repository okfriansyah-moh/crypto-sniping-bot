...
type: skill
description: >
  Learning engine patterns (Layer 10): adaptive threshold updates, cohort analysis,
  false positive/negative computation, shadow trade tracking, bounded updates, and
  LearningRecord production. This is the only component that makes the system compound
  over time — get it wrong and the system never improves.
---
