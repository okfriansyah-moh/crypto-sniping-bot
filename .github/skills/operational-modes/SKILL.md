...
type: skill
description: >
  Operational mode management patterns (STRICT / BALANCED / EXPLORATION). Use when
  implementing or reviewing mode transitions, starvation recovery, mode-specific
  threshold profiles, and transition guards. Wrong mode management causes either
  starvation (too strict) or catastrophic overtrading (too loose).
---
