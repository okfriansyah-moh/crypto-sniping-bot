...
type: skill
description: >
  Anti-manipulation and scam detection algorithms for the Data Quality Engine
  (Layer 1). Use when implementing or reviewing wash trading detection, rug pull
  identification, honeypot simulation, fake liquidity patterns, and tax manipulation
  analysis. These are the specific algorithms — not generic security advice. Wrong
  implementation lets scams through and destroys all capital.
---
