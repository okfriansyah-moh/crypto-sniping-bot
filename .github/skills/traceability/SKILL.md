...
type: skill
description: >
  Four-field traceability contract enforcement. Use when implementing or reviewing
  DTO propagation, event emission, trace ID assignment, and correlation chain
  integrity. Every DTO crossing a module boundary MUST carry all four traceability
  fields. Missing fields make learning attribution, replay, and debugging impossible.
---
