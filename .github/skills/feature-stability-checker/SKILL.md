---
name: feature-stability-checker
type: skill
description: >
  Gate features out of edge and probability scoring when their directional
  consistency over a rolling window drops below a configurable threshold.
  Use when implementing or reviewing feature weighting in the FeatureDTO
  pipeline (Layer 2) and EdgeDTO scoring (Layer 3). Unstable features get
  weight=0 with proportional redistribution to stable features.
---
