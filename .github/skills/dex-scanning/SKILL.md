...
type: skill
description: >
  DEX market scanning patterns for on-chain event ingestion. Use when implementing
  or reviewing the ingestion layer (Layer 0), DEXScreener integration, RPC event
  subscription, new pool detection, and MarketDataDTO production.
---
