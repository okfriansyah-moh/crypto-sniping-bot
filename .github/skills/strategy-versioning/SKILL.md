...
type: skill
description: >
  Strategy versioning, A/B promotion, and config snapshot patterns. Use when
  implementing or reviewing StrategyVersion creation, version attribution on trades,
  A/B promotion gates, rollback mechanics, and replay determinism. Every config
  change MUST be traceable to an exact version snapshot.
---
...
- Architecture context: `docs/archive/architecture-context/13_observability_finalization.md`
