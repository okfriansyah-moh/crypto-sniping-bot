...
**Required skills:** idempotency, failure, database-portability, config-validation, modularity, migration-management, event-bus, token-lifecycle, traceability, dto, determinism, code-quality, coding-standards
